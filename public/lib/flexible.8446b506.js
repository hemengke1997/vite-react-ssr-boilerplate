;(function () {
  ...
  const t = document.documentElement.getAttribute('is-mobile') === 'true' ? 'mobile' : 'pc',
    i = { pc: { maxWidth: 1920, minWidth: 1300, UIWidth: 1920 }, mobile: { maxWidth: 750, minWidth: 0, UIWidth: 750 } }
  function n() {
